...
internal fun SecureMessageMiuixPage(
    ...
    var enabled by remember { mutableStateOf(sp.getBoolean(SecureMessageSettings.KEY_ENABLE, true)) }
            ...
            item {
                SettingsCard {
                    SwitchRow(
                        ...
                        onCheckedChange = {
                            enabled = it
                            sp.edit().putBoolean(SecureMessageSettings.KEY_ENABLE, it).apply()
                        }
                    )
                }
            }
