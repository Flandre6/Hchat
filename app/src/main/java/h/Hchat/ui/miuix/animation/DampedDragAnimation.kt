package h.Hchat.ui.miuix.animation
...
import h.Hchat.ui.miuix.animation.inspectDragGestures
...
class DampedDragAnimation(
    ...
    suspend fun animateToValue(value: Float) {
        mutatorMutex.mutate {
            press()
